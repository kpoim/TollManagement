    ...
    <body>
        ...
        <div class="cont">
            <div class="form ">
                ...
                <form:form action="${pageContext.request.contextPath}/check-answer" method="post">
                    ...
                    <label for="newanswer"><span>Answer</span>
                        <input type="text" name="newanswer" value="${newanswer}"><br />
